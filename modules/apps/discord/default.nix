...
in
{
  options.koi.apps.discord = with types; {
  ...
  config = mkIf (cfg.enable or cfg.chromium.enable) {
    environment.systemPackages =
      ...
      ++ lib.optional cfg.canary.enable pkgs.koi.discord
      ++ lib.optional cfg.chromium.enable pkgs.koi.discord-chromium
      ++ lib.optional cfg.firefox.enable pkgs.koi.discord-firefox
