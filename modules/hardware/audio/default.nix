...
with lib;
with lib.internal;
let cfg = config.koi.hardware.audio;
in
{
  options.koi.hardware.audio = with types; {
  ...
  config = mkIf cfg.enable {
    ...
    services.pipewire = {
      ...
      media-session.config.alsa-monitor =
        mkAliasDefinitions options.koi.hardware.audio.alsa-monitor;
